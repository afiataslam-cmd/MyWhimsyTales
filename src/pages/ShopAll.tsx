    ...
    <div className="pt-20 pb-24">
      <section className="bg-card/10 py-20 mb-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <span className="text-xs uppercase tracking-[0.5em] text-accent mb-4 block">The Full Collection</span>
          <h1 className="text-5xl font-serif italic text-footer">Shop All Treasures</h1>
        </div>
      </section>
